...
function BookingFooter() {
  return (
    <footer className="relative overflow-hidden">
      {/* Dark background matching hero aesthetic */}
      <div className="absolute inset-0 bg-gradient-to-b from-background via-[hsl(var(--card))] to-black/95" />

      <div className="relative z-10">
        {/* Contact CTA Section */}
        <div className="border-t border-border/50 py-12 sm:py-16 px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-6">
              ...
              <div className="text-center space-y-3">
                ...
                <a
                  ...
                  className="inline-block text-xs text-primary hover:underline font-medium mt-1"
                >
                  Get Directions &rarr;
                </a>
              </div>
              ...
              <div className="text-center space-y-3">
                ...
                <div className="space-y-1.5 text-sm">
                  <p>
                    <a href="tel:+34971XXXXXX" className="text-muted-foreground hover:text-primary transition-colors font-medium">
                      +34 971 XXX XXX
                    </a>
                  </p>
                  <p>
                ...
                <p className="text-xs text-muted-foreground/70 mt-1">
                  Large groups (12+) &bull; Same-day reservations
                </p>
              </div>
              ...
              <div className="text-center space-y-3">
                ...
                <div className="flex items-center justify-center gap-3 pt-2">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center w-9 h-9 rounded-full bg-muted hover:bg-primary/20 transition-colors"
                  ...
                  <a
                    href="https://facebook.com/cheersmallorca"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center w-9 h-9 rounded-full bg-muted hover:bg-primary/20 transition-colors"
                    aria-label="Facebook"
        ...
        {/* Bottom bar */}
        <div className="border-t border-border/30 py-6 px-4">
          <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-xs text-muted-foreground/60">
              &copy; 2026 GrandCafe Cheers. All rights reserved.
            </p>

            <nav className="flex flex-wrap justify-center gap-x-4 gap-y-1 text-xs text-muted-foreground/60">
              ...
              <a href="/legal/refund" className="hover:text-foreground transition-colors">Refunds</a>
              <a href="/legal/aviso-legal" className="hover:text-foreground transition-colors">Aviso Legal</a>
            </nav>
          </div>

          <p className="text-center text-[10px] text-muted-foreground/40 mt-4 max-w-5xl mx-auto">
            Hojas de Reclamaciones disponibles en el establecimiento &bull;{' '}
            <a
              href="https://www.caib.es/sites/consum"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-muted-foreground/60 transition-colors underline"
            >
